...
import { centralAsiaFeaturedTreatments } from "@/lib/featuredTreatmentImages";

const country = getCountry("uzbekistan")!;
  ...
  return (
    <CountryHub
      content={{
        ...
        dedicatedPages,
        featuredTreatments: centralAsiaFeaturedTreatments,
      }}
    />
  );
}
