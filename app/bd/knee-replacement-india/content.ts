...
export const content = {
  en: {
    ...
    reports: {
      ...
      uploadHint: "PDF, JPG, PNG, DOC — up to 10MB per file, max 5 files",
    ...
    reportForm: {
      ...
      errors: {
        ...
        fileSize: '"{name}" is larger than the 10MB limit.',
  ...
  bn: {
    ...
    reports: {
      ...
      uploadHint: "PDF, JPG, PNG, DOC — প্রতি ফাইল সর্বোচ্চ 10MB, সর্বোচ্চ ৫টি ফাইল",
    ...
    reportForm: {
      ...
      errors: {
        ...
        fileSize: '"{name}" ফাইলটি 10MB সীমার চেয়ে বড়।',
