...
// A representative sample for the homepage carousel, one per hospital where
// possible, favoring doctors with a real photo on file — not the full
// 65-doctor roster (that lives on /doctors). Falls back gracefully if a
// hospital has no photographed doctor yet.
