...
const PAGE_URL = "https://www.truecare24.in/oman/cardiac-treatment-india";

export const metadata: Metadata = {
  title:
    "Cardiac & Heart Treatment in India for Patients from Oman | TrueCare",
  description:
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Cardiac Treatment in India (Oman)",
      item: PAGE_URL,
    },
  ],
};
